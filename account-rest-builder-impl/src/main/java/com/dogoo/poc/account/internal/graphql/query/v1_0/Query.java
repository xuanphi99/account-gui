...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {detail(accountId: ___){accountId, fullName, email, newUser, password, phone, departmentId, positionId, userIdMapping, roles}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
